...
> `agteamos-standards`). Para detectar cuándo un PR concreto se aleja de
...
| C# / ASP.NET Core | [../clean-architecture/examples/csharp.md](../clean-architecture/examples/csharp.md) + [csharp-cqrs-mediatr.md](../clean-architecture/examples/csharp-cqrs-mediatr.md) |
| TypeScript / Node.js | [../clean-architecture/examples/typescript.md](../clean-architecture/examples/typescript.md) |
