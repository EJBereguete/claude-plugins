---
name: agteamos-definition-of-ready
description: >
  Valida si un ticket tiene la informacion minima para empezar a trabajar.
  Si no la tiene, activa agteamos-clarification-protocol para completar lo que falta.
...
- **Output**: READY (proceder) o NOT READY (activar agteamos-clarification-protocol)
...
¿Es testeable?
  NO → Definir criterio de verificacion con el usuario
    ↓
READY → Proceder con agteamos-story-breakdown
```
...
→ Activar agteamos-clarification-protocol:
