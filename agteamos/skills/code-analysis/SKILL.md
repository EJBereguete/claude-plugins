---
name: agteamos-code-analysis
description: >
  Static code analysis por lenguaje (linting, type checking, security
  scanning) y quality gates en CI. Referencia de herramientas y
  configuracion para mantener deuda tecnica bajo control de forma continua.
used_by:
  - security-engineer
---
