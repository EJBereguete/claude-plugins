---
name: agteamos-build-ui-workflow
description: >
...
**If it does not exist**: continue without blocking, but record explicitly when
presenting the wireframe (Step 3) that "no `agteamos/standards/` found — could not
verify against project standards" so this shows up as traceable, not silently skipped.
